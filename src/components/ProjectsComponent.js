...
const ProjectsComponent = () => {
    ...
    <div className="main_content">
        ...
        <div className="container">
            <div className="activity-box">
                <h3>AKTIVNOST: 4. Edukacije, stručno osposobljavanje i stjecanje novih znanja zaposlenika; ovoj aktivnosti se nabavlja:</h3>
        ...
        <div className="container">
            <div className="activity-box">
                <h3>UKUPNA ULAGANJA: 2.013.038,42 kn</h3>
